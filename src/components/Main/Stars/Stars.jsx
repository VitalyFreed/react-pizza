...
const Stars = ({selectStars, currentRating, count, handleHoverRating, handleHoverRatingLeave, handleClickRating}) => {
    return (
        <div className={styles.stars}>
            {
                [1, 2, 3, 4, 5].map((elem, i) => <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                                      width="16.000000pt" height="16.000000pt"
                                                      viewBox="0 0 1280.000000 1216.000000"
                                                      preserveAspectRatio="xMidYMid meet"
                                                      onMouseEnter={e => handleHoverRating(i)}
                                                      onMouseLeave={handleHoverRatingLeave}
                                                      onClick={e => handleClickRating(i)}
                                                      key={i}
                                                      className={(currentRating > i || selectStars > i )? styles.star : ''}
                >
                    <g transform="translate(0.000000,1216.000000) scale(0.100000,-0.100000)"
                       fill="#bd5e65" stroke="none">
